//package com.somnus.guava.cache.guava;
//
...
//	private static Map<String, ? extends BaseLoadingCache<Object, Object>> cacheNameToObjectMap = null;
//
//	/**
...
//	private static Map<String, ? extends BaseLoadingCache<Object, Object>> getCacheMap(){
//		if(cacheNameToObjectMap==null){
//			cacheNameToObjectMap = (Map<String, ? extends BaseLoadingCache<Object, Object>>) SpringContextUtil.getBeanOfType(BaseLoadingCache.class);
//		}
...
//	 * @return
//	 */
//	private static BaseLoadingCache<Object, Object> getCacheByName(String cacheName){
//		return (BaseLoadingCache<Object, Object>) getCacheMap().get(cacheName);
//	}
//
//	/**
//	 * 获取所有缓存的名字（即缓存实现类的名称）
...
//		BaseLoadingCache<Object, Object> cache = getCacheByName(cacheName);
...
//
//		BaseLoadingCache<Object, Object> cache = getCacheByName((String) pageParams.getParams().get("cacheName"));
