...
//            jedisPool.returnResource(jedis);
    ...
    public class Keys {
         ...
         *
         * @param parame key
         * @param key    parame 定义排序类型或limit的起止位置.
    ...
    public class SortSet {
         ...
         *
         * @param score key
         * @param score score 权重
         * @param score member 要加入的值，
         ...
         *
         * @param key key
         * @param min min 最小排序位置
         * @param max max 最大排序位置
         */
         ...
         *
         * @param key    key
         * @param score  score 要增的权重
         * @param member member 要插入的值
         * @return 增后的权重
         */
         ...
         *
         * @param key   key
         * @param start start 开始位置(包含)
         * @param end   end 结束位置(包含)
         * @return Set<String>
         */
         ...
         *
         * @param start key
         * @param start start 开始区间，从0开始(包含)
         * @param start end 结束区间,-1为最后一个元素(包含)
         * @return 删除的数量
         */
         ...
         *
         * @param min key
         * @param min min 下限权重(包含)
         * @param min max 上限权重(包含)
         * @return 删除的数量
         */
    ...
    public class Strings {
         ...
         *
         * @param seconds key
         * @param value   seconds 过期时间，以秒为单位
         * @param value   value
         * @return String 操作状态
         */
         ...
         *
         * @param endOffset key
         * @param endOffset startOffset 开始位置(包含)
         ...
         * 批量存储记录
         *
         * @param keysvalues keysvalues 例:keysvalues="key1","value1","key2","value2";
         * @return String 状态码
         */
    ...
    public class Lists {
         ...
         *
         * @param c     key
         * @param value c 要删除的数量，如果为负数则从List的尾部检查并删除符合的记录
         * @param value value 要匹配的值
